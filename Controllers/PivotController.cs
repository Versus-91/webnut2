...
namespace DataSystem.Controllers
{
 ...
 totalbegin = m.Totalbegin.GetValueOrDefault(),
            ...
            pivotSheet["A2"].Text = "OPD-MAM - Children";
            ...
            if (req.option == 1)
            {
                ...
                IPivotField pCurrate = pivotTable.CalculatedFields.Add("Curedd", "Cured/TotalExitsNoRefOuts");
                pCurrate.Name = "%cured";
                pCurrate.NumberFormat = "#.0%";

                IPivotField pDeath = pivotTable.CalculatedFields.Add("Death", "Deaths/TotalExitsNoRefOuts");
                pDeath.Name = "%death";
                pDeath.NumberFormat = "#.0%";

                IPivotField pDefaulters = pivotTable.CalculatedFields.Add("Defaulter", "Defaulters/TotalExitsNoRefOuts");
                ...
                IPivotField pNonCured = pivotTable.CalculatedFields.Add("NonCured", "NonCured/TotalExitsNoRefOuts");
        ...
        public IActionResult pivotMN([Bind("ProvCode,Year,option")]CreateReq req)
        {
            ...
            if (req.option == 1)
            {
                ...
                pivotTable.DataFields.Add(chu2m, "Children U2 Female", PivotSubtotalTypes.Sum);
